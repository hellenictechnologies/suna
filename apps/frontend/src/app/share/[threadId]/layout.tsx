...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | hellenicAI',
    description: 'Replay this Worker conversation on hellenicAI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | hellenicAI';
    const description =
      projectData.description ||
      'Replay this Worker conversation on hellenicAI';
