          ...
          <div className="relative w-full px-6">
            <div className="max-w-6xl mx-auto border-l border-r border-border">
              ...
              <div className="border-t border-border">
                <FAQItem
                  question="What is hellenicAI?"
                  answer="hellenicAI is a generalist AI worker that can perform real-world tasks on your behalf. Unlike traditional AI assistants, hellenicAI can actually take action across your apps, automate workflows, and handle complex multi-step tasks autonomously."
                />
                <FAQItem
                  question="How can hellenicAI help me?"
                  answer="hellenicAI can automate repetitive tasks, manage your workflows, interact with web services, process data, create content, and coordinate complex operations across multiple platforms. Simply tell hellenicAI what you need done, and it handles the execution from start to finish."
                />
                <FAQItem
                  question="How is hellenicAI different from other AI platforms?"
                  answer="While most AI platforms only provide information or suggestions, hellenicAI actually performs real-world tasks. It can browse the web, interact with APIs, manage files, execute commands, and integrate with your existing tools to complete tasks autonomously—not just tell you how to do them."
                />
                <FAQItem
                  question="Can hellenicAI connect to my apps?"
                  answer="Yes! hellenicAI can connect to thousands of apps and services through integrations. It can interact with your tools, APIs, databases, and workflows to automate tasks across your entire tech stack. You control which apps and services hellenicAI can access."
                />
                <FAQItem
