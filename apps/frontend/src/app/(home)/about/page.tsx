...
const paragraphs: ParagraphItem[] = [
  ...
  "hellenicAI is an AI agent that doesn't just give you answers—it gets things done. Research, code, write, manage projects, execute workflows. The whole job.",
        ...
        <div className="mt-24 md:mt-32">
          ...
          <div className="md:hidden border border-foreground/10 rounded-sm p-6">
            ...
            <div className="text-center mt-6">
              <Image src="/ht-symbol.png" alt="hellenicAI" width={16} height={13} className="inline-block opacity-20 dark:invert" />
            </div>
          </div>
          ...
          <div className="hidden md:grid grid-cols-2 border border-foreground/10 rounded-sm">
            ...
            <div className="relative border-r border-foreground/10 p-6 flex flex-col aspect-[3/4]">
              ...
              <div className="text-center mt-4">
                <Image src="/ht-symbol.png" alt="Hellenic AI" width={16} height={13} className="inline-block opacity-20 dark:invert" />
              </div>
            </div>
