                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        hellenicAI Corp is responsible for the content of this
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        CAREFULLY BEFORE USING THE SERVICES OFFERED BY hellenicAI
                        ...
                        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE hellenicAI
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        <li>
                          "Company" refers to hellenicAI Corp, a Delaware corporation
                          with its principal place of business at 701 Tillery Street
                          Unit 12-2521, Austin, Texas 78702, United States.
                        </li>
                        <li>
                          "Site" refers to the hellenicAI website, including any related
                          features, content, or applications offered from time to
                          time by the Company.
                        </li>
                        <li>
                          "Service" refers to the hellenicAI platform and all related
                        ...
                        <li>
                          ...
                          Company, specifically info@hellenictechnologies.com
                        </li>
                        <li>
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        hellenicAI is a complete platform for creating, managing, and
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        please write to info@hellenictechnologies.com and we will process and
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        or by emailing us at info@hellenictechnologies.com. If you cancel
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        GitHub repository. Self-hosting is governed by the hellenicAI Public
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All hellenicAI logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE hellenicAI WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        hellenicAI DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        <strong>Mailing Address:</strong> hellenicAI Corp, 701 Tillery
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at hellenicAI in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        hellenicAI does not collect biometric or identifying
