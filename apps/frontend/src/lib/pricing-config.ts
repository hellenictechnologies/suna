...
export const pricingTiers: PricingTier[] = [
  {
    ...
    description: 'Perfect for trying out hellenicAI Workers',
    ...
    features: [
      ...
      '1 concurrent run',
      'Basic Mode - Core hellenicAI experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create hellenicAI Workers with custom Knowledge, Tools & Integrations',
      ...
      'hellenicAI Advanced mode - Strongest autonomy & decision-making capabilities',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create hellenicAI Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create hellenicAI Workers with custom Knowledge, Tools & Integrations',
